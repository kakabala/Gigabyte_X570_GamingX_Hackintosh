...
{
    External (\_SB.PCI0.BXBR.BYUP.BYD8, DeviceObj)
    External (\_SB.PCI0.BXBR.BYUP.BYD8.XHC0.RHUB, DeviceObj)
    External (\_SB.PCI0.BXBR.BYUP.BYD8.XHC1, DeviceObj)
    External (\_SB.PCI0.GP13.XHC0.RHUB, DeviceObj)

    Scope (\_SB.PCI0.BXBR.BYUP.BYD8.XHC0.RHUB)
    {
    ...
    Scope (\_SB.PCI0.BXBR.BYUP.BYD8.XHC1)
    {
        Method (_STA, 0, NotSerialized)  // _STA: Status
        {
            If (_OSI ("Darwin"))
